						...
						<div class="col-lg-8 col-md-8 col-sm-8">
							<div class="section-title">
								...
								<div class="genre-btn-wrap">
									<span>#<button onclick="moveToGenres(this)">액션</button></span>
									<span>#<button onclick="moveToGenres(this)">판타지</button></span>
									<span>#<button onclick="moveToGenres(this)">공포</button></span>
									<span>#<button onclick="moveToGenres(this)">코미디</button></span>
									<span>#<button onclick="moveToGenres(this)">SF</button></span>
									<span>#<button onclick="moveToGenres(this)">로맨스</button></span>
								</div>
...
function pageScroll(page) {
	...
	for(let i=0; i<itemPics.length; i++) {						//마지막 페이지에 없는건 안찍기 위해 초기화
		...
		document.querySelectorAll('.product__item__text a')[i].innerHTML = '';
		document.querySelectorAll('.product__item__text li')[i].innerHTML = '';
	}
	fetch('/recommendMovies-scroll?pageNum=' + num + '&pageSize=' + itemPics.length)
	.then(function(res) {
		return res.json();
	})
	.then(function(data) {
		...
		for(let i=0; i<data.size; i++) {
			...
			document.querySelectorAll('.product__item__text a')[i].innerHTML = data.list[i].title;
