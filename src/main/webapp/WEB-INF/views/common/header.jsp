						...
						<c:if test="${userInfo ne null}">
							<div class="dropdown">
								<button class="btn btn-secondary dropdown-toggle" type="button"
									...
									${userInfo.uiNickname}님</button>
								<ul class="dropdown-menu">
									<li><a class="dropdown-item"
										href="/views/auth/my-page?uiNum=${userInfo.uiNum}">마이페이지</a></li>
									<li><a class="dropdown-item"
										href="/views/auth/user-activity?uiNum=${userInfo.uiNum}">활동
											내역</a></li>
...
function searchMovies() {		//검색 function
